...
layers configuration. You are free to put any user code."
  ...
  ; Make C-u delete minibuffer contents
  (define-key minibuffer-local-map "\C-u" 'delete-minibuffer-contents)
  ...
  ;; Make 'g' go to top of page in grep-mode.
  (add-hook 'grep-mode-hook
            (lambda ()
              (define-key grep-mode-map (kbd "g") #'evil-goto-first-line)))
